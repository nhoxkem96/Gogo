...
-(id)initWithTextField:(UITextField *)tf withData:(NSArray*) data
{
    ...
    if (self) {
        ...
        self->placeholder = @"Chọn danh mục bài viết";
        self->placeholderWhileSelecting = @"Chọn danh mục bài viết";
		self->toolbarDoneButtonText = @"Đồng ý";
        self->toolbarCancelButtonText = @"Hủy";
