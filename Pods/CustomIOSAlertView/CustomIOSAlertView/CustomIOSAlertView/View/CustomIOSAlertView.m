...
- (void)show
{
    ...
    self.backgroundColor = [UIColor colorWithRed:31 green:137 blue:255 alpha:1];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setBackgroundColor:[UIColor colorWithRed:31/255.0 green:137/255.0 blue:255/255.0 alpha:1]];
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    for (int i = viewsToRemove.count - 1 ; i > 0 ; i --) {
        [viewsToRemove[i] removeFromSuperview];
        break;
    }
}
